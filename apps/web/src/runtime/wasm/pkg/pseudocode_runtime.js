/* @ts-self-types="./pseudocode_runtime.d.ts" */

/**
 * @param {string} request_json
 * @returns {string}
 */
export function run_pseudocode(request_json) {
    let deferred2_0;
    let deferred2_1;
    try {
        const ptr0 = passStringToWasm0(request_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.run_pseudocode(ptr0, len0);
        deferred2_0 = ret[0];
        deferred2_1 = ret[1];
 ...
 * @returns {boolean}
 */
export function runtime_ready() {
    const ret = wasm.runtime_ready();
    return ret !== 0;
}
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./pseudocode_runtime_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'string' || (typeof Request === 'function' && module_or_path instanceof Request) || (typeof URL === 'function' && module_or_path instanceof URL)) {
        module_or_path = globalThis.fetch(module_or_path);
    }
